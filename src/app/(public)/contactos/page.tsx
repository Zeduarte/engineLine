...
export const metadata: Metadata = {
  title: "Contactos",
  description:
    "Fale com o engineLine. Morada, horário, telefone, WhatsApp e mapa do showroom em Lisboa.",
};
    ...
    <div className="pb-24 pt-32 md:pt-40">
      ...
      <section className="container-px mt-16 grid gap-12 lg:grid-cols-2">
        <Reveal stagger={0.1} className="space-y-8">
          ...
          <ContactBlock label="Horário">{site.hours}</ContactBlock>
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <a
              href={whatsappHref("Olá! Gostava de mais informações.")}
              target="_blank"
